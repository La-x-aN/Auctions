...
namespace Auctions.Controllers
{
    public class ListingsController : Controller
    {
        ...
        public ListingsController(IListingsService listingsService, IWebHostEnvironment webHostEnvironment, IBidsService bidsService, ICommentsService commentsService , UserManager<IdentityUser> userManager)
        {
        ...
        public async Task<IActionResult> Create(ListingVM listing)
        {
            if (ModelState.IsValid)
            {
                ...
                var listObj = new Listing
                {
                    ...
                    IdentityUserId = listing.IdentityUserId // Ensure this is set
                };
